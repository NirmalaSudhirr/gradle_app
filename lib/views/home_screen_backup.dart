...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget buildMonitorCardX(BuildContext context, {bool desktop = false}) {
    return LayoutBuilder(
      builder: (context, constraints) {
        return Card(
          elevation: 0,
            ...
            child: Obx(() {
              ...
              return Column(
                ...
                children: [
                  ...
                  // FIX: Replace Expanded with SizedBox for height constraint
                  SizedBox(
  ...
  Widget buildQrCardX(BuildContext context, {bool desktop = false}) {
    final ctrl = Get.find<ReportController>();
    final TextEditingController textCtrl = TextEditingController(
      text: ctrl.inputText.value,
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: desktop ? 12 : 6),
            // The improved responsive input + button row/column:
            LayoutBuilder(
              builder: (context, constraints) {
                final isNarrow = constraints.maxWidth < 400;
                if (isNarrow) {
                            ...
                            onPressed:
                                ctrl.inputText.value.trim().isNotEmpty
                                    ? () async {
                                      ...
                                      textCtrl.clear();
                                      // setState not required, UI will react thanks to GetX
                                    }
                                    : null,
                          ),
                        ),
